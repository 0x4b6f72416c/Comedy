...
export default function StageDetailsPage( {route,navigation}){
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View>
                ...
                <FlatList
                    ...
                    data={item.stage_reviews} 
                    keyExtractor={(item)=>{item.creator.name}}
                    renderItem={({item})=>{
                        return(
                            <View style={styles.review}>
                                <View style={{flexDirection:'row'}}>
                                    <View style={styles.reviewerImg}></View>
                                    <Text style={{marginLeft:20}}>{item.creator.name}</Text>
                                </View>
                                <View>
                                    <Text>{item.text}</Text>
                                </View>
...
StageDetailsPage.sharedElements = (route, otherRoute,showing)=>{
